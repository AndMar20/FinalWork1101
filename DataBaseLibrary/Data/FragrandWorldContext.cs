...
public partial class FragrandWorldContext : DbContext
{
    public FragrandWorldContext()
    {
    }

    public FragrandWorldContext(DbContextOptions<FragrandWorldContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Data Source = DESKTOP-OH9DFE9\\SQLSERVER; Initial Catalog = ispp2109; User ID = ispp2109; Password = 2109; Trust Server Certificate=True");
